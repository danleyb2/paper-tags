  ...
  static get template() {
    ...
    <paper-menu-button id="menuButton" vertical-align="[[verticalAlign]]" horizontal-align="[[horizontalAlign]]" vertical-offset="[[_computeMenuVerticalOffset(noLabelFloat)]]" disabled="[[disabled]]" no-animations="[[noAnimations]]" opened="{{opened}}" close-on-activate="" allow-outside-scroll="[[allowOutsideScroll]]" restore-focus-on-close="[[restoreFocusOnClose]]">
      ...
      <div slot="dropdown-trigger">
        ...
        <paper-tags-input id="tagInput" max-tags="[[maxTags]]" min-tags="[[minTags]]" prevent-remove-tag="[[preventRemoveTag]]" value-object="{{valueObject}}" value-array="{{valueArray}}" tag-tpl="[[tagTpl]]" items="[[tagItems]]" value="{{value}}" icon="[[icon]]" item-class="[[itemClass]]" class-path="[[classPath]]" label-path="[[labelPath]]" icon-path="[[iconPath]]" key-path="[[keyPath]]" invalid="[[invalid]]" readonly="[[readonly]]" disabled="[[disabled]]" placeholder="[[placeholder]]" always-float-label="[[alwaysFloatLabel]]" no-label-float="[[noLabelFloat]]" error-message="[[errorMessage]]" label="[[label]]" show-counter="[[showCounter]]" get-style="[[getTagStyle]]" get-label="[[getLabel]]" get-name="[[getName]]">
      ...
      <paper-listbox slot="dropdown-content" disabled="[[disabled]]" selected-values="{{valueArray}}" attr-for-selected="name" multi="">
        <template is="dom-if" if="[[allowSearch]]">
          <paper-input id="filterCt" label="filter" value="{{searchString}}" on-tap="_stopEventPropagation" on-keydown="_stopEventPropagation" on-keyup="_stopEventPropagation"></paper-input>
        </template>
